...
@section('title')Prelibato | Privacy - Food Marketing e Comunicazione a Eboli Salerno Campania @endsection
@section('description')Prelibato è un'agenzia di marketing e comunicazione in Campania a Eboli, Salerno. Food marketing e comunicazione per aziende agroalimentari e ristoranti @endsection
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 privacy">
        ...
        <p>Noi di <strong><span id="sito">http://prelibato.eu</span></strong> riteniamo che la privacy dei nostri visitatori sia estremamente importante. Questo documento descrive dettagliatamente i tipi di informazioni personali raccolti e registrati dal nostro sito e come essi vengano utilizzati.</p>
        ...
        <div id="cookies" style="display: block;">
          ...
          <ul>
            <li><strong>Attività strettamente necessarie al funzionamento</strong>
              ...
              <ul>
                <li><b><span id="azienda">Prelibato srl</span></b></li>
                <li id="piva" style="display: block;">P. IVA <span id="iva">05699060652</span></li>
                <li id="codiceFiscale" style="display: none;">Codice Fiscale: <span id="codice_Fiscale"></span></li>
                <li><span id="indirizzo">via XXIV Maggio, 9</span></li>
                <li><span id="cap">84025</span> - <span id="citta">SALERNO</span> (<span id="provincia">CAMPANIA</span>)</li>
                <li>E-mail: <span id="email">info@prelibato.eu</span></li>
              </ul>
