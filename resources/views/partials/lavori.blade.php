  ...
  <div class="container">
    ...
    <div class="row st-row">
      ...
      <div class="offset-lg-2 offset-md-2 offset-sm-2 col-md-5 col-lg-5 wow fadeInUp" data-wow-duration="1.5s">
        <a title="Clicca e apri il progetto" href="{{route('colella')}}">
          <div class="box" id="boxuno">
            <h1 class="title">COLELLA</h1>
            <span>branding | advertising | digital strategy</span>
          </div>
        </a>
        <p>Colella Pizzeria Contemporanea: un giovane ed appassionato pizzaiolo con una grande esperienza internazionale e un food lover sempre alla ricerca di produttori artigianali e materie prime di qualità.</p>
        <a title="Clicca e apri il progetto" href="{{route('colella')}}"><img class="img-fluid" data-wow-duration="1.5s" src="{{asset('img/portfolio/colella/copertina.gif')}}" alt="Cucù Progetto"></a>
      </div>
